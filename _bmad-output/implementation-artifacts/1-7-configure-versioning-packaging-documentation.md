...
- [ ] Task 4: Set up Sphinx documentation (AC: 4, 5)
  ...
  - [ ] 4.2: Create `docs/conf.py` with Sphinx + Furo + Napoleon extension configuration
  - [ ] 4.3: Create `docs/index.rst` as documentation root
  - [ ] 4.4: Verify `sphinx-apidoc -f -e -o docs/api src/ncaa_eval` generates API stubs
  - [ ] 4.5: Verify `sphinx-build -b html docs docs/_build/html` generates HTML without errors
